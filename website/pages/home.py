            ...
            rx.card(
                rx.vstack(
                    ...
                    rx.text(
                        ...
                        " me explain what I do in my day-to-day. I think in fact this"
                        " would be closer to what a Research Scientist does, since my"
                        " work is focused in creating prototypes using technologies as"
                        " Graph Neural Networks, Deep Learning Explainability or"
                        " Bayesian Neural Networks. Specifically, I am one of the"
                        " Machine Learning leads of the organization, driving the"
                        " research part of several teams. And, finally, one of the"
                        " parts that I am most proud of: I am one of the founders of"
                        " Ericsson Cognitive Labs, our open-source initiative to"
                        " release part of our research open-source. There I am the Head"
                        " of the Geometric Artificial Intelligence (GAI) Lab, which is"
                        " specially focused in Graph Neural Networks."
                    ),
                    rx.text(
